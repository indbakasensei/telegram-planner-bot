...
# Current production models (NVIDIA NIM) as of v15.7:
# - GLM 5.2 is the default main + reasoning model (z-ai/glm-5.2)
# - MODEL_FAST is meta/llama-3.1-8b-instruct
# - MODEL_VISION is meta/llama-3.2-90b-vision-instruct
# - MODEL_IMAGE is black-forest-labs/flux.1-schnell
# - MODEL_VIDEO is stabilityai/stable-video-diffusion
# - deepseek-ai/deepseek-r1 is available on NIM
...
MODEL_COSTS = {
    ...
    "meta/llama-3.3-70b-instruct":             {"in": 0.40, "out": 0.40, "provider": "NVIDIA NIM"},
    "black-forest-labs/flux.1-schnell":        {"in": 0,    "out": 0,    "provider": "NVIDIA NIM", "per_image": 0.03},
...
def estimate_cost(model_name: str, prompt_tokens: int = 0,
    ...
    if not info:
        # Try a loose match (e.g. "glm-5.2" matches "z-ai/glm-5.2")
